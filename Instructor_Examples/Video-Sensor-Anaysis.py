...
from utils.resize_image import resize_image  # Adjust import as needed
...
videos_folder = 'data/Videos/'  # Adjust path to your video folder

# Initialize YOLO model
model = YOLO('yolov8n-pose.pt')

# Initialize CSV file
csv_file = 'Instructor_Examples/Results/results.csv'
...
for video_file in os.listdir(videos_folder):
    if video_file.endswith(('.mp4', '.avi')):  # Filter by video extensions
