...
df = pd.read_csv('Instructor_Examples/Results/final_results_all_stats.csv') # All stats from all videos
...
df_charac.to_csv(f'all_stats_{characToCheck}_fogRatio_updrsIII.csv', index=False)
